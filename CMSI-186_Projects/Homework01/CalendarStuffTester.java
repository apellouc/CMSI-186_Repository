 ...
 *  Notes         :  There are 60 tests here. Tests
 ...
 *  @version 1.0.1  2017-01-26  Amy Pellouchoud Added some tests to further understand material
 */
...
public class CalendarStuffTester {
   ...
   */
   public static void main ( String [] args ) {
      test_isLeapYear();      // 14 tests
      test_daysInMonth();     // 14 tests
      test_isValidDate();     //  8 tests
      test_dateEquals();      //  7 tests
      test_compareDate();     //  4 tests
      test_daysBetween();     // 13 tests
   }
   ...
   */
   static void test_isLeapYear(){
      ...
      System.out.print( "   Amy's Test for year 1584: " );
      try { System.out.println( CalendarStuff.isLeapYear( 1584 ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println (false); }

      System.out.print( "   Amy's Test for year 4: " );
      try { System.out.println( CalendarStuff.isLeapYear( 4 ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println (false); }

      System.out.print( "   Amy's Test for year 5: " );
      try { System.out.println( CalendarStuff.isLeapYear( 5 ) ? "true" : "false" ); }
      catch( Exception e ) { System.out.println (false); }
   ...
   */
   static void test_daysInMonth() {
      ...
      System.out.println( "\nFOURTEEN TESTS FOR daysInMonth():" );
      ...
      System.out.print( "   Amy's Test: February 1584 : " );
      try { System.out.println( 29 == CalendarStuff.daysInMonth( 2, 1584 ) ? "correct, 29" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }
   }
   ...
   */
   static void test_compareDate() {
      ...
      System.out.print( "   Amy's Test: January 15, 1987 with February 29, 2008  : ");
      try { System.out.println(  -1 == CalendarStuff.compareDate(  1, 15, 1987,  2, 29, 2008 ) ? "first < second" : "YOU LOSE" ); }
      catch( Exception e ) { System.out.println( false ); }
   ...
   */
   static void test_daysBetween() {
      ...
      System.out.println ( "\nTHIRTEEN TESTS FOR daysBetween():" );
     ...
     System.out.print( "   Amy's Test: Counting 2 days between 01-02-1956 and 12-31-1955 : " );
     try { System.out.println(    2 == CalendarStuff.daysBetween( 1, 2, 1956, 12, 31, 1955 ) ? "2 days" : "bad count" ); }
     catch ( Exception e ) { System.out.println( false ); }
