 ...
 *  Purpose       :  Provides a class defining methods for the ClockSolver class (also use with SoccerSim.java)
 *  @author       :  Amy Pellouchoud
 *  Date written  :  2017-02-28
 *  Description   :  This class provides a bunch of methods which may be useful for the ClockSolver class
 *                   for Homework 4, part 1. Also use for SoccerSim - Homework 05.
 *  Notes         :  None
 *  Warnings      :  None
